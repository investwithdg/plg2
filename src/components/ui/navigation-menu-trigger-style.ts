...
// Split out of navigation-menu.tsx: react-refresh/only-export-components requires a component
// file to only export components, so this cva() result (a value, not a component) lives here.

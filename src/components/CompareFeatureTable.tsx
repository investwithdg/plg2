...
export function CompareFeatureTable({ rival, category }: CompareFeatureTableProps) {
  ...
  switch (category) {
    ...
    case "visual":
      features = [
        { feature: "Primary purpose", plg: "Writing listing copy that sells", rival: "Virtual staging & photo editing" },
        { feature: "FHA Fair Housing compliance", plg: "Built-in training & guardrails", rival: "N/A" },
        { feature: "Text generation", plg: "MLS, Social, Email formats", rival: "None" },
        { feature: "Integration", plg: "Generates the text for your listing", rival: "Generates the visuals for your listing" },
      ];
      break;
    case "portal":
      features = [
        { feature: "Primary purpose", plg: "Independent listing copy generator", rival: "Locked ecosystem portal" },
        { feature: "FHA Fair Housing compliance", plg: "Built-in training & guardrails", rival: "Basic filters" },
        ...
        <div className="win95-inset overflow-x-auto">
          <table className="w-full text-win95-11 border-collapse">
            <thead><tr className="bg-[var(--win95-gray)]">
              ...
              <th className="text-left p-2 border-b border-[var(--win95-gray-dark)] font-bold">{rival}</th>
            </tr></thead>

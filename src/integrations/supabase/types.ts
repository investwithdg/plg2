  ...
  public: {
    Tables: {
      ...
      compliance_checks: {
        ...
        Relationships: [
          {
            foreignKeyName: "compliance_checks_copy_generation_id_fkey";
            columns: ["copy_generation_id"];
            isOneToOne: false;
            referencedRelation: "copy_generations";
      ...
      listing_outcomes: {
        ...
        Relationships: [
          {
            foreignKeyName: "listing_outcomes_copy_generation_id_fkey";
            columns: ["copy_generation_id"];
            isOneToOne: false;
            referencedRelation: "copy_generations";
            referencedColumns: ["id"];

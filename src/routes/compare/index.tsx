...
export const Route = createFileRoute("/compare/")({
  head: () => ({
    meta: [
      {
        title: "PLG vs Competitors — Property Listing Generator Comparisons",
      },
      {
        name: "description",
        content:
...
const DEEP_DIVE_COMPARISONS = [
  {
    ...
    verdict: "DealMachine helps you find deals. PLG writes the listing copy once you have one.",
  },
  {
  ...
  {
    slug: "/compare/chatgpt",
    rival: "ChatGPT / OpenAI",
    tagline: "General AI vs Listing Copy Engine",
    verdict:
  ...
  },
  {
    slug: "/compare/jasper",
    rival: "Jasper AI",
    tagline: "Marketing AI vs Real Estate AI",
    verdict:
  ...
  },
  {
    slug: "/compare/copyai",
    rival: "Copy.ai",
    tagline: "General Copywriting vs Listing Copy",
    verdict:
      "Copy.ai writes marketing copy for SaaS and e-commerce. It doesn't know what Fair Housing compliance is.",
  },
  {
    slug: "/compare/writesonic",
    rival: "Writesonic",
    tagline: "General AI Writer vs Specialist",
    verdict:
  ...
  },
  {
    slug: "/compare/epique",
    rival: "Epique AI",
    tagline: "Real Estate AI Suite vs Listing Copy Specialist",
    verdict:
  ...
  },
  {
    slug: "/compare/kvcore",
    rival: "kvCORE",
    tagline: "Real Estate CRM vs Listing Copy Engine",
    verdict:
      "kvCORE is a CRM with basic AI features. Its copy tools are add-ons, not its core product.",
  },
  {
    slug: "/compare/followupboss",
    rival: "Follow Up Boss",
    tagline: "Real Estate CRM vs Listing Generator",
    verdict: "A lead management CRM. No listing copy generation whatsoever.",
  },
  {
    slug: "/compare/curaytor",
    rival: "CuraytoR / Ylopo",
    tagline: "Marketing Platform vs Copy Engine",
    verdict:
      "Full-service real estate marketing platforms focused on ads and lead gen. Not built for listing copy.",
  },
  {
    slug: "/compare/reimaginehome",
    rival: "REimagineHome",
    tagline: "Virtual Staging vs Listing Copy",
    verdict:
      "AI-powered virtual staging and renovation visualization. Doesn't write a single word of copy.",
  },
  {
    slug: "/compare/virtualstagingai",
    rival: "Virtual Staging AI",
    tagline: "Virtual Staging vs Text Generation",
    verdict:
  ...
  {
    slug: "/compare/grammarly",
    rival: "Grammarly",
    tagline: "Writing Assistant vs Writing Engine",
    verdict:
      ...
      <div className="w-full max-w-3xl space-y-4">
        ...
        <div className="win95-window">
          <div className="win95-titlebar">
            <span className="font-bold text-win95-12 truncate pl-1">PLG vs Competitors</span>
          ...
          <div className="p-4 space-y-4">
            <p className="text-win95-12">
              PropertyListingGenerator.com is the only tool purpose-built for real estate listing
              copy. See how it compares to every alternative agents consider.
            </p>

            {/* Why PLG section */}
            <div className="win95-inset p-3">
              <p className="text-win95-12 font-bold mb-2">Why PLG vs. writing it yourself</p>
        ...
        {/* Featured comparison */}
        {featured && (
          <Link to={featured.slug} className="block no-underline">
            <div className="win95-window group cursor-pointer">
              ...
              >
                <span className="font-bold text-win95-12 truncate pl-1">★ Featured Comparison</span>
              </div>
              <div className="p-4 group-hover:bg-[color:var(--win95-blue)] group-hover:text-white transition-colors">
                ...
                <h2 className="text-win95-14 font-bold mb-2">{featured.tagline}</h2>
        ...
        {rest.length > 0 && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {rest.map((c, i) => (
              <Link key={c.slug} to={c.slug} className="block no-underline">
                <div className="win95-window h-full group cursor-pointer">
                  ...
                  <div className="p-3 group-hover:bg-[color:var(--win95-blue)] group-hover:text-white transition-colors h-full">
                    ...
                    <h3 className="text-win95-12 font-bold mb-1 line-clamp-2">{c.tagline}</h3>

...
export const Route = createFileRoute("/compare/writesonic")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Writesonic is a general AI writer for blogs and ads. PLG is purpose-built for FHA-compliant real estate listing copy with automated property research." },
      { property: "og:title", content: "PLG vs Writesonic — Property Listing Generator Comparison" },
      { property: "og:description", content: "Writesonic writes blog posts. PLG writes compliant listing copy in 15 seconds." },
    ],
  }),
      ...
      <div className="w-full max-w-3xl space-y-4">
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            <h1 className="text-win95-16 font-bold">PLG vs Writesonic: Content Platform vs. Listing Copy Engine</h1>
            <p className="text-win95-12"><strong>Writesonic</strong> is an AI content platform focused on SEO blog posts, Google Ads, landing pages, and product descriptions. It's popular with content marketers and small business owners who need volume content.</p>
            <p className="text-win95-12">It has no real estate training, no FHA compliance awareness, no property research capability, and no understanding of MLS formatting requirements. You'd need to provide every detail manually and still review for compliance.</p>
            <p className="text-win95-12"><strong>PLG</strong> automates the entire listing copy workflow: paste an address, get three compliant, researched outputs in 15 seconds.</p>
          </div>
        </div>
          ...
          <div className="p-3"><div className="win95-inset overflow-x-auto">
            <table className="w-full text-win95-11 border-collapse">
              <thead><tr className="bg-[var(--win95-gray)]">
                ...
                <th className="text-left p-2 border-b border-[var(--win95-gray-dark)] font-bold">Writesonic</th>
              </tr></thead>
        ...
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            <p className="text-win95-12">Writesonic is a solid content marketing tool. For <strong>real estate listing copy</strong> — compliant, researched, formatted for MLS, social, and email — PLG is the purpose-built solution that saves agents hours every week.</p>

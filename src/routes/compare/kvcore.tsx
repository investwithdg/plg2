...
export const Route = createFileRoute("/compare/kvcore")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "kvCORE is a powerful CRM with basic AI add-ons. PLG is a dedicated, FHA-compliant listing copy generator." },
      { property: "og:title", content: "PLG vs kvCORE — Property Listing Generator Comparison" },
      { property: "og:description", content: "CRM vs. Listing Copy Engine. See why agents use PLG alongside their CRM." },
    ],
  }),
  component: VsKvCore,
});
      ...
      <div className="w-full max-w-3xl space-y-4">
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            ...
            <p className="text-win95-12"><strong>kvCORE</strong> is a massive, powerful CRM and lead generation platform used by brokerages. While it has added some basic AI text generation features, writing listing copy is a tiny footnote in its massive feature set.</p>
            <p className="text-win95-12"><strong>PLG</strong> is a dedicated listing copy engine. It does one thing, but it does it better than any CRM's built-in tool, featuring FHA compliance checks and real-time property research.</p>
          </div>
        </div>
          ...
          <div className="p-3"><div className="win95-inset overflow-x-auto">
            <table className="w-full text-win95-11 border-collapse">
              <thead><tr className="bg-[var(--win95-gray)]">
                ...
                <th className="text-left p-2 border-b border-[var(--win95-gray-dark)] font-bold">kvCORE</th>
              </tr></thead>
        ...
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            <p className="text-win95-12">You don't choose between kvCORE and PLG. You use kvCORE to manage your leads and your business, and you use <strong>PLG</strong> to write the perfect listing copy when you win the listing.</p>

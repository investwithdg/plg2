      ...
      <div className="w-full max-w-3xl space-y-4">
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            <h1 className="text-win95-16 font-bold">PLG vs Canva Magic Write: Design Tool vs. Listing Copy Engine</h1>
            <p className="text-win95-12"><strong>Canva</strong> is a phenomenal graphic design platform. Its Magic Write feature adds basic AI text generation inside the design editor — useful for generating captions, headlines, and short blurbs for social media graphics.</p>
            <p className="text-win95-12">But Magic Write is a design add-on, not a listing copy tool. It has no FHA training, no property research, no MLS awareness, and generates only short snippets — not the structured, multi-format output real estate agents need.</p>
            <p className="text-win95-12"><strong>PLG</strong> generates complete MLS descriptions, social posts, and email blurbs from a single address — researched, compliant, and ready to publish.</p>
          </div>
        </div>
          ...
          <div className="p-3"><div className="win95-inset overflow-x-auto">
            <table className="w-full text-win95-11 border-collapse">
              <thead><tr className="bg-[var(--win95-gray)]">
                ...
                <th className="text-left p-2 border-b border-[var(--win95-gray-dark)] font-bold">Canva Magic Write</th>
              </tr></thead>
        ...
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            <p className="text-win95-12">Use Canva for your listing flyers and social graphics — it's excellent at that. Use <strong>PLG</strong> for the listing copy that goes inside those designs. They complement each other; they don't compete.</p>

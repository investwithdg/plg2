  ...
  head: () => ({
    meta: [
      { title: "PLG vs Follow Up Boss — Property Listing Generator Comparison" },
      {
        name: "description",
        content:
          "Follow Up Boss is a lead management CRM. PLG is a listing copy generator. They don't compete; they complement each other.",
      },
      {
        property: "og:title",
    ...
    <div className="min-h-screen bg-[var(--background)] p-4 flex flex-col items-center">
      <div className="w-full max-w-3xl space-y-4">
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            ...
            <p className="text-win95-12">
              <strong>Follow Up Boss (FUB)</strong> is widely considered the best real estate CRM
              for managing leads and teams. But it is purely a CRM—it does not write listing copy.
            </p>
            <p className="text-win95-12">
              <strong>PLG</strong> generates the listing copy that actually attracts those leads.
              Once PLG helps you market the listing via the MLS, social media, and email, FUB is
              where you manage the buyers who respond.
            </p>
          </div>
        </div>
        ...
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            <p className="text-win95-12">
              Use <strong>Follow Up Boss</strong> to work your leads. Use <strong>PLG</strong> to
              generate the listing copy that gets those leads to call you in the first place.
            </p>

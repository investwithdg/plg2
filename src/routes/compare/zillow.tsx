...
export const Route = createFileRoute("/compare/zillow")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Zillow's AI tool is locked to their platform. PLG generates copy for the MLS, social media, and email simultaneously." },
      { property: "og:title", content: "PLG vs Zillow AI Description — Property Listing Generator Comparison" },
...
const FEATURES = [
  { feature: "Primary purpose", plg: "Independent listing copy generator", rival: "Zillow listing enhancer" },
  { feature: "Platform lock-in", plg: "None — use the copy anywhere", rival: "Locked to Zillow ecosystem" },
  { feature: "MLS formatting", plg: "Yes — character limits respected", rival: "No — designed for portal display" },
      ...
      <div className="w-full max-w-3xl space-y-4">
        <div className="win95-window">
          <div className="win95-titlebar">
            <span className="font-bold text-win95-12 truncate pl-1">PLG vs Zillow AI Description</span>
          ...
          <div className="p-4 space-y-3">
            ...
            <p className="text-win95-12"><strong>Zillow</strong> recently introduced an AI description generator. It's a nice feature if you are manually entering a listing directly into Zillow. However, it's locked into their ecosystem and doesn't format the copy for your local MLS, Instagram, or email marketing.</p>
            <p className="text-win95-12"><strong>PLG</strong> is an independent tool. You generate the copy once, and you own it. You can paste the MLS description into your local MLS, post the social copy to Facebook, and send the email blurb to your buyers list.</p>
          </div>
        </div>
          ...
          <div className="p-3"><div className="win95-inset overflow-x-auto">
            <table className="w-full text-win95-11 border-collapse">
              <thead><tr className="bg-[var(--win95-gray)]">
                ...
                <th className="text-left p-2 border-b border-[var(--win95-gray-dark)] font-bold">Zillow AI</th>
              </tr></thead>
        ...
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            <p className="text-win95-12">If you need copy to use <strong>across all your marketing channels</strong> and your local MLS, PLG is the clear winner.</p>

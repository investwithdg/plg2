  ...
  head: () => ({
    meta: [
      { title: "PLG vs REimagineHome — Property Listing Generator Comparison" },
      {
        name: "description",
        content:
          "REimagineHome is an AI virtual staging tool. PLG writes listing copy. They do completely different things.",
      },
      {
        property: "og:title",
        ...
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            ...
            <p className="text-win95-12">
              <strong>REimagineHome</strong> is an incredible AI tool for virtual staging. It lets
              you upload a photo of an empty room and use AI to add furniture, change flooring, and
              visualize renovations.
            </p>
            <p className="text-win95-12">
              <strong>PLG</strong> is an incredible tool for copywriting. It researches the property
              and writes the FHA-compliant text for the MLS, social media, and email.
            </p>
            <p className="text-win95-12 font-bold">
              They don't compete. A great listing uses REimagineHome for the visuals and PLG for the
              words.
            </p>

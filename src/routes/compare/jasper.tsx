...
export const Route = createFileRoute("/compare/jasper")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Jasper writes marketing copy. PLG writes listing copy. See the full comparison." },
    ],
  }),
  component: VsJasper,
});
...
const FEATURES = [
  ...
  { feature: "Real estate domain expertise", plg: "Purpose-built for agents", rival: "Broad marketing focus" },
  { feature: "Free tier", plg: "10 free generations + 1 Pro-tier", rival: "7-day trial, then $49/mo+" },
      ...
      <div className="w-full max-w-3xl space-y-4">
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            <h1 className="text-win95-16 font-bold">PLG vs Jasper AI: Marketing Platform vs. Listing Copy Specialist</h1>
            <p className="text-win95-12">
              <strong>Jasper AI</strong> is a well-known marketing AI platform used by content teams, SaaS companies, and e-commerce brands. It offers templates for blog posts, ad copy, product descriptions, and social media content.
            </p>
            <p className="text-win95-12">
              What Jasper doesn't offer: FHA Fair Housing compliance, real property research, MLS formatting, or any awareness that real estate listing copy has unique legal requirements.
            </p>
            <p className="text-win95-12">
              <strong>PLG</strong> is built exclusively for real estate agents. It researches the actual property, formats for MLS, social, and email, and ensures every word passes FHA compliance checks — all in 15 seconds from a single address.
            </p>
          </div>
        </div>
        ...
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            <div className="win95-inset p-3 space-y-2">
              <p className="text-win95-12">
                <strong>Jasper's templates are generic.</strong> Their "real estate listing" template asks you to fill in every detail manually — beds, baths, features, neighborhood info. PLG looks all of that up automatically.
              </p>
              <p className="text-win95-12">
                <strong>No FHA awareness.</strong> Jasper's AI has no concept of Fair Housing Act restrictions. It will happily generate phrases that could get you fined. PLG's guardrails are non-negotiable.
              </p>
              <p className="text-win95-12">
                <strong>You're paying for features you don't use.</strong> Jasper includes blog writing, ad copy, and brand voice tools. If all you need is listing copy, you're paying for a Swiss Army knife when you need a scalpel.
              </p>
            </div>
          </div>
        </div>
              ...
              <table className="w-full text-win95-11 border-collapse">
                <thead>
                  <tr className="bg-[var(--win95-gray)]">
                    ...
                    <th className="text-left p-2 border-b border-[var(--win95-gray-dark)] font-bold">Jasper AI</th>
                  </tr>
                </thead>
                <tbody>
                  {FEATURES.map((row, i) => (
        ...
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            <p className="text-win95-12">
              Jasper is a strong marketing platform — for marketers. If you're a real estate agent who needs <strong>compliant, researched, format-specific listing copy</strong>, Jasper is like hiring a general contractor to hang a picture frame. PLG is the picture hanger.
            </p>

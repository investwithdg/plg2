  ...
  head: () => ({
    meta: [
      { title: "PLG vs CuraytoR / Ylopo — Property Listing Generator Comparison" },
      {
        name: "description",
        content:
          "CuraytoR and Ylopo are full-service marketing and ad platforms. PLG is a lightweight, instant listing copy generator.",
      },
      {
        property: "og:title",
        content: "PLG vs CuraytoR / Ylopo — Property Listing Generator Comparison",
      },
      {
...
const FEATURES = [
  {
    ...
    rival: "Full-service marketing & ads",
  },
    ...
    <div className="min-h-screen bg-[var(--background)] p-4 flex flex-col items-center">
      <div className="w-full max-w-3xl space-y-4">
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            ...
            <p className="text-win95-12">
              <strong>CuraytoR</strong> and <strong>Ylopo</strong> are massive, full-service
              marketing platforms. They build websites, run Facebook ads, and handle lead
              generation. They cost thousands of dollars a month and require significant onboarding.
            </p>
            <p className="text-win95-12">
        ...
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            <p className="text-win95-12">
              If you want an agency to run your ads, hire CuraytoR. If you want a tool that
              instantly writes your listing descriptions so you can get them on the market today,
              use <strong>PLG</strong>.
            </p>

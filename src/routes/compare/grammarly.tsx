  ...
  head: () => ({
    meta: [
      { title: "PLG vs Grammarly — Property Listing Generator Comparison" },
      {
        name: "description",
        content:
          "Grammarly is a writing assistant that catches typos. PLG actually writes the listing copy, researches the property, and ensures FHA compliance.",
      },
        ...
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            ...
            <p className="text-win95-12">
              <strong>Grammarly</strong> is a fantastic tool for catching typos, fixing commas, and
              improving sentence structure. If you write your own listing descriptions from scratch,
              you should definitely run them through Grammarly.
            </p>
            <p className="text-win95-12">
              <strong>PLG</strong> solves a different problem: the blank page. PLG does the
              research, formats the copy, and writes the actual text. You don't need Grammarly for
              PLG's output because the AI already uses perfect grammar.
            </p>
            <p className="text-win95-12 font-bold">
              Grammarly edits what you write. PLG writes it for you.
            </p>

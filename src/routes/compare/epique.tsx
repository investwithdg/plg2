...
export const Route = createFileRoute("/compare/epique")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Epique AI is a broad real estate AI suite. PLG is deeply specialized in FHA-compliant, research-backed listing copy generation." },
      { property: "og:title", content: "PLG vs Epique AI — Property Listing Generator Comparison" },
      { property: "og:description", content: "Broad AI suite vs. listing copy specialist. See the full comparison." },
    ],
  }),
  component: VsEpique,
});
      ...
      <div className="w-full max-w-3xl space-y-4">
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            <h1 className="text-win95-16 font-bold">PLG vs Epique AI: Specialist vs. Generalist Suite</h1>
            <p className="text-win95-12"><strong>Epique AI</strong> offers a wide variety of AI tools for real estate agents, including bio writers, legal document summaries, and listing descriptions. It's a broad suite of tools that attempts to do a little bit of everything.</p>
            <p className="text-win95-12"><strong>PLG</strong> focuses exclusively on one problem and solves it deeply: generating the best, most compliant, and well-researched listing copy possible across MLS, social, and email formats.</p>
          </div>
        </div>
          ...
          <div className="p-3"><div className="win95-inset overflow-x-auto">
            <table className="w-full text-win95-11 border-collapse">
              <thead><tr className="bg-[var(--win95-gray)]">
                ...
                <th className="text-left p-2 border-b border-[var(--win95-gray-dark)] font-bold">Epique AI</th>
              </tr></thead>
        ...
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            <p className="text-win95-12">If you want a Swiss Army knife of AI tools and are part of the Epique ecosystem, their suite is useful. If you want the absolute best tool for writing <strong>listing copy</strong> that is FHA-compliant, researched, and formatted perfectly, PLG is the superior choice.</p>

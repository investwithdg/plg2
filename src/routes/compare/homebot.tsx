  ...
  head: () => ({
    meta: [
      { title: "PLG vs Homebot — Property Listing Generator Comparison" },
      {
        name: "description",
        content:
          "Homebot is a homeowner engagement platform. PLG is a listing copy generator. Completely different tools for completely different jobs.",
      },
...
const FEATURES = [
  {
    ...
    rival: "Homeowner equity reports & engagement",
  },
  {
    feature: "Target user",
    plg: "Listing agents",
    rival: "Lenders & agents retaining past clients",
  },
  ...
  { feature: "Property research", plg: "Yes (Perplexity AI)", rival: "Home value estimates only" },
  {
    ...
    rival: "Monthly homeowner digest emails",
  },
  {
    feature: "Use case timing",
    plg: "When you list a property",
    rival: "Ongoing client nurturing",
  },
    ...
    <div className="min-h-screen bg-[var(--background)] p-4 flex flex-col items-center">
      <div className="w-full max-w-3xl space-y-4">
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            <h1 className="text-win95-16 font-bold">
              PLG vs Homebot: Listing Copy vs. Client Engagement
            </h1>
            <p className="text-win95-12">
              <strong>Homebot</strong> is a homeowner engagement platform used primarily by loan
              officers and agents to stay connected with past clients. It sends automated monthly
              reports showing home equity, refinance opportunities, and local market data.
            </p>
            <p className="text-win95-12">
              Homebot does not generate listing copy. It doesn't write MLS descriptions, social
              media posts, or marketing emails for listings. It's a client retention tool, not a
              listing tool.
            </p>
            <p className="text-win95-12">
              <strong>PLG</strong> is what you use when you have a listing and need compliant,
              researched copy fast. Homebot is what you use to stay top-of-mind with past clients.
        ...
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            <p className="text-win95-12">
              Homebot and PLG serve completely different parts of the real estate workflow.{" "}
              <strong>Homebot nurtures past clients. PLG writes listing copy.</strong> Many agents
              use both — Homebot for retention, PLG when it's time to list.
            </p>

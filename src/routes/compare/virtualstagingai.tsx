  ...
  head: () => ({
    meta: [
      { title: "PLG vs Virtual Staging AI — Property Listing Generator Comparison" },
      {
        name: "description",
        content:
          "Virtual Staging AI puts furniture in photos. PLG writes listing copy. Two different AI tools for real estate.",
      },
      {
        property: "og:title",
        ...
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            ...
            <p className="text-win95-12">
              <strong>Virtual Staging AI</strong> does exactly what its name says: it uses AI to
              stage vacant listing photos.
            </p>
            <p className="text-win95-12">
              <strong>PLG</strong> is a listing copy generator. It writes the text that goes next to
              those staged photos on the MLS, on Instagram, and in your email blasts.
            </p>
            <p className="text-win95-12 font-bold">
              Both use AI to save you time and money, but they handle completely different parts of

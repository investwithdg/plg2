  ...
  head: () => ({
    meta: [
      { title: "PLG vs Realtor.com AI — Property Listing Generator Comparison" },
      {
        name: "description",
        content:
          "Realtor.com's AI tool is embedded in their portal. PLG generates copy for the MLS, social media, and email simultaneously.",
      },
      {
        property: "og:title",
        content: "PLG vs Realtor.com AI — Property Listing Generator Comparison",
      },
      {
...
const FEATURES = [
  {
    ...
    rival: "Realtor.com listing enhancer",
  },
  {
    feature: "Platform lock-in",
    plg: "None — use the copy anywhere",
    rival: "Locked to Realtor.com ecosystem",
  },
    ...
    <div className="min-h-screen bg-[var(--background)] p-4 flex flex-col items-center">
      <div className="w-full max-w-3xl space-y-4">
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            <h1 className="text-win95-16 font-bold">
              PLG vs Realtor.com: Independent Tool vs. Portal Feature
            </h1>
            <p className="text-win95-12">
              Like Zillow, <strong>Realtor.com</strong> has integrated some AI generation tools into
              its professional dashboard. However, this tool is designed to enhance listings within
              their specific ecosystem.
            </p>
            <p className="text-win95-12">
              <strong>PLG</strong> is your independent copywriter. It researches the property and
              formats the text so you can use it in your local MLS, your Instagram feed, and your
              marketing emails.
            </p>
          </div>
        </div>
        ...
        <div className="win95-window">
          ...
          <div className="p-4 space-y-3">
            <p className="text-win95-12">
              If you want to control your marketing and use your copy everywhere, you need an
              independent tool like <strong>PLG</strong>.
            </p>

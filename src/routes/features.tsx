          ...
          <div className="p-4 space-y-4">
            <div className="win95-inset bg-[var(--win95-gray)] text-black p-4">
              ...
              <p className="text-win95-12">
                ...
                real estate copywriting engine designed to save you hours while keeping 
            ...
            <div className="flex justify-center mt-6">
              <Link to="/" className="win95-raised bg-[var(--win95-gray)] text-black px-4 py-2 text-win95-12 font-bold no-underline active:win95-pressed cursor-pointer">
                Try it now
              </Link>
            </div>
          </div>
